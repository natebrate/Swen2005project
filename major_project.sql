...
--
/*!50003 DROP PROCEDURE IF EXISTS `buyProducts` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `buyProducts`(IN product_id int(10), IN amount_bought int(10))
BEGIN
update products set quantity=quantity+amount_bought where prod_id=product_id;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `newProduct`(IN produceName varchar(100), IN quantity_bought int(10), IN cost_value float(8,2), IN sell_value float(8,2))
BEGIN
insert into products(name, quantity, cost, price) VALUES (produceName, quantity_bought, cost_value, sell_value);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `removeProduct`(IN ID int(10))
BEGIN
...
-- Dump completed on 2020-05-20 12:19:24

...
INSERT INTO `products` VALUES (1,'Sekiro: Shadows  Die Twice',40,55.00),(2,'Zelda: Twilight Princess',40,30.00),(3,'Just Cause 4 Bundle',22,40.00),(4,'Zelda: Breath of the Wild',60,45.70),(5,'Muramasa: The Demon Blade',15,12.00),(6,'Okami HD',10,25.80),(7,'Super Mario Galaxy Bundle',5,60.00),(8,'Super Smash Brothers Ultimate',54,57.00),(9,'Persona 5: The Royal',54,55.00),(10,'Skullgirls 2nd Encore',20,32.00),(11,'Pokemon Sword and Shield Bundle',4,75.95);
...
CREATE TABLE `sales_details` (
  ...
  KEY `P_ID` (`P_ID`),
  CONSTRAINT `sales_details_ibfk_1` FOREIGN KEY (`P_ID`) REFERENCES `products` (`prod_id`),
  CONSTRAINT `sales_details_ibfk_2` FOREIGN KEY (`invoice`) REFERENCES `sales_summary` (`invoice`)
...
INSERT INTO `sales_details` VALUES (2,1,2,30.00),(2,3,2,70.00);
...
INSERT INTO `sales_summary` VALUES (2,4,100.00,'2020-05-29');
...
-- Dump completed on 2020-05-29 14:59:58
